...
<head>
	...
	<title>Login | E-Journal & E-Skripsi STMIK Dharma Negara</title>
		...
		<div class="content-wrapper">
			...
			<div class="content-inner">
				...
				<div class="content d-flex justify-content-center align-items-center">
					...
					<!-- Login form -->
					<form class="login-form wmin-sm-400" action="{{ route('mahasiswa1.postlogin') }}" method="POST">
						<div class="card mb-0">
							<div class="tab-content card-body">
                                <div class="text-center mb-3">
                                    <i class="icon-reading icon-2x text-secondary border-secondary border-3 rounded-pill p-3 mb-3 mt-1"></i>
                                    <h5 class="mb-0"><i>E-Journal & E-Skripsi</i> STMIK Dharma Negara</h5>
                                    <span class="d-block text-muted">Login Mahasiswa</span>
                                </div>
                                ...
                                <span class="form-text text-center text-muted">&copy; 2022. <i><a href="">E-Journal & E-Skripsi</a></i> STMIK Dharma Negara Bandung.</span>
							</div>
						</div>
					</form>
					<!-- /login form -->
