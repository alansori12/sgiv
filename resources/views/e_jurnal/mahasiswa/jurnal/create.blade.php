...
<div class="row pt-3">
    ...
    <div class="card col-md-8">
        ...
        <div class="card-body">
            <form action="{{ route('mahasiswa1.artikelmahasiswa.store')}}" method="POST" enctype="multipart/form-data">
                <fieldset class="mb-3">
                    @csrf
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3">Tanggal</label>
                        <div class="col-lg-9">
                            <input type="date" class="form-control" name="tanggal" value="{{old('tanggal')}}" autofocus autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
						<input type="text" class="form-control" name="penyusun" readonly="" value="{{ Auth::guard('mahasiswa')->user()->nm_mhs }}">
                        </div>
                    </div>
